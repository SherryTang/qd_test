...
SOPCINFO_FILE := D:/fpga/ad_new_ep3c25f324c8n/qsys/qsys_sdram.sopcinfo
...
# Design Name 
# setting SOPC_NAME is qsys_sdram
SOPC_NAME := qsys_sdram
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1008
SOPC_SYSID_FLAG += --sidp=0x1008
ELF_PATCH_FLAG  += --sidp 0x1008

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1464758967
SOPC_SYSID_FLAG += --timestamp=1464758967
ELF_PATCH_FLAG  += --timestamp 1464758967
